...
public class BidService {
    ...
    @Autowired
    public BidService(BidRepository bidRepository, ProductRepository productRepository, UserRepository userRepository,BidMapper bidMapper){
    ...
    private Product getProduct(String productId) {
        ...
        if (!optionalProduct.isPresent()) {
            throw new IllegalArgumentException("User Product ID!");
        }
